export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1fd7362e36a685ac",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "751bcf7cb77b31a79d03b150ebc569ca",
  ...
  USERS: [
    {
      ...
      id: "oSk2C6shIb9AuFi2MdOVkqBMr3jE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "n0awDCLDx7OQC1_Aw4JBXvwyIiWod8mZQwydmd9wStE",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "成都",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "郑媳妇", "year": "2000", "date": "06-16"},
        {"type": "节日", "name": "纪念日", "year": "2021", "date": "04-10"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小吴", "year": "2001", "date": "06-26"},
        {"type": "节日", "name": "纪念日", "year": "2021", "date": "04-10"},
      ],
